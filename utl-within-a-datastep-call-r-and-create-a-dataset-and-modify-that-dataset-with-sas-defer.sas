...
The key to this solution is defering the opening a second sas dataset until
R has created the second dataset. All in one datastep.
   ...
   Beore execution SAS has to know about all the variables needed
   in the final output dataset.

   However if the defered file is a v5 transport you do not
   ...
   FOUR SOLUTIONS
        ...
        1. r defered v5 xpt ile
        2. r defered sas dataset (uses stattransfer)
        3. python defered v5 xpt
        4. python defered sas dataset (uses stattransfer)
